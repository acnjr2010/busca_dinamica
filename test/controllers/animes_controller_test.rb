...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { author: @anime.author, episodes: @anime.episodes, manga: @anime.manga, name: @anime.name, year: @anime.year } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { author: @anime.author, episodes: @anime.episodes, manga: @anime.manga, name: @anime.name, year: @anime.year } }
